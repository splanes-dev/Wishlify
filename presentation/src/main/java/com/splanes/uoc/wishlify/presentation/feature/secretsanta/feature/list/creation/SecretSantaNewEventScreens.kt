...
@Composable
fun SecretSantaNewEventBasicsScreen(
  uiState: SecretSantaNewEventUiState,
  ...
  Box(modifier = Modifier.fillMaxSize()) {
    Scaffold(
      ...
      topBar = {
        TopAppBar(
          title = { Text(text = stringResource(R.string.secret_santa_new_event_title)) },
          actions = {
            IconButton(
...
@OptIn(ExperimentalMaterial3Api::class, ExperimentalMaterial3ExpressiveApi::class)
@Composable
fun SecretSantaNewEventParticipantsScreen(
  uiState: SecretSantaNewEventUiState,
  onCreateGroup: () -> Unit,
  onSearchUsers: () -> Unit,
...
@OptIn(ExperimentalMaterial3Api::class, ExperimentalMaterial3ExpressiveApi::class)
@Composable
fun SecretSantaNewEventExclusionsScreen(
  uiState: SecretSantaNewEventUiState,
